...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE.url}/symptoms`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE.url}/pricing`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE.url}/credentials`, lastModified: now, changeFrequency: "yearly", priority: 0.7 },
